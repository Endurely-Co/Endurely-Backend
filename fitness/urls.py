...
urlpatterns = [
    ...
    path('user-fitness-profile/all', views.FitnessUserView.as_view(), name="fitness-user-fitness"),
    path('user-fitness-profile', views.FitnessUserView.as_view(), name="fitness-user-fitness-profile")
]
